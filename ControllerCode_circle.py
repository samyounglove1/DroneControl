...
class DroneController:
    ...
    def _control_loop(self):
        ...
        while self.control:
            ...
            elif RunTime<10 and RunTime >= 5:
                x_goal = 1
                y_goal = 0
                z_goal = 1.5

            elif RunTime < 20 and RunTime >= 10:
                x_goal = np.cos(2*np.pi*0.1 * RunTime)
                y_goal = np.sin(2*np.pi*0.1 * RunTime)
                z_goal = 1.5

            elif RunTime < 25 and RunTime >= 20:
                x_goal = 1
                y_goal = 0
                z_goal = 1.5
